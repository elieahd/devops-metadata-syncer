...
import devops.metadata.syncer.infrastructure.outbound.github.models.GitHubPackage;
...
import devops.metadata.syncer.infrastructure.outbound.github.models.GitHubVulnerability;
...
class EnterpriseGitHubRepositoryInventoryTest {

    private FakeGitHubClient gitHubClient;
    private EnterpriseGitHubRepositoryInventory inventory;
    ...
    void setUp() {
        ...
        inventory = new EnterpriseGitHubRepositoryInventory(
                gitHubClient,
